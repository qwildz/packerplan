                        ...
                        <div class="box">
                            <div class="box-header">
                                ...
                                <div class="box-tools">
                                    <div class="input-group">
                                        <form name="fcari_user" action="hcari_komentar.php" method="post"
                                              class="sidebar-form">
                                            <div class="input-group">
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-hover">
                                    ...
                                    $query = mysql_query("SELECT  a.id_komentar,a.username,c.nama,b.nama_rencana,b.waktu,a.teks FROM komentar a, rencana b , user c WHERE (a.id_rencana=b.id_rencana) AND (a.username=c.username)") or die(mysql_error());
                                    ...
                                    else
                                    {
                                        ...
                                        {    //perulangan while dg membuat variabel $data yang akan mengambil data di database
                                            ...
                                            echo '<td>' . $data['nama_rencana'] . '</td>';    //menampilkan data nama lengkap dari database
                                            echo '<td>' . $data['waktu'] . '</td>';    //menampilkan data kelas dari database
                                            echo '<td>' . $data['teks'] . '</td>';    //menampilkan data kelas dari database
                                            echo '<td><a href="hapus_komentar.php?id=' . $data['id_komentar'] . '" onclick="return confirm(\'Yakin?\')"><button class="btn btn-danger">Hapus</button></a></td>';
                                            echo '</tr>';
