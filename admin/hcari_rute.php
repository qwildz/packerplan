                                ...
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <div class="input-group">
                                           <form name="fcari_user"action="hcari_rute.php" method="post" class="sidebar-form" >
												<div class="input-group">
										...
										if(mysql_num_rows($query) == 0){	//ini artinya jika data hasil query di atas kosong
											...
											while($data = mysql_fetch_assoc($query)){	//perulangan while dg membuat variabel $data yang akan mengambil data di database
												...
												echo '<tr>';
													...
													echo '<td><a href="detail.php?id='.$data['id_rencana'].'"><button class="btn btn-info">Detail</button></a><a href="hapus_rute.php?id='.$data['id_rute'].'" onclick="return confirm(\'Yakin?\')"><button class="btn btn-danger">Hapus</button></a></td>';
												echo '</tr>';
