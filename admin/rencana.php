                            ...
                            <div class="box-header">
                                ...
                                <div class="box-tools">
                                    <div class="input-group">
                                        <form name="fcari_user" action="hcari_rencana.php" method="post"
                                              class="sidebar-form">
                                            <div class="input-group">
                                ...
                                <table class="table table-hover">
                                    ...
                                    else
                                    {
                                        ...
                                        {    //perulangan while dg membuat variabel $data yang akan mengambil data di database
                                            ...
                                            echo '<td><a href="detail_rencana.php?id=' . $data['id_rencana'] . '"><button class="btn btn-info">Detail</button></a><a href="hapus_rencana.php?id=' . $data['id_rencana'] . '" onclick="return confirm(\'Yakin?\')"><button class="btn btn-danger">Hapus</button></a></td>';
                                            echo '</tr>';
